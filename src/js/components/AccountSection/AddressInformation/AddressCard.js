            ...
            <li>
                <div className="col  col-xs-12 col-md-12 col-lg-3">
                    <p style={{textAlign:'initial'}}>
                        <span><strong style={{fontWeight:600}}><FormattedMessage id="profile.Address.Title" defaultMessage="Address" />: {this.props.address.address_type} </strong>
                        ...
                        <div className="div-displayflex">
                            <Link to={{pathname:`/${store_locale}/edit-address-accout`,addressProps:this.props.address,updateAddressRedirect:true}}  className="btn-edit-address mr-remove-remove m-left"><FormattedMessage id="profile.Edit.Title" defaultMessage="Edit" /></Link>
