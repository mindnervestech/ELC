...
class AddressFormAdd extends Component {
    ...
    handleValidation = () => {
        ...
        if (!fields["firstName"]) {
            formIsValid = false;
            errors["firstName"] = <FormattedMessage id="Amirah.FirstNameError" defaultMessage="Please enter first name." />;
        }
        ...
        if (!fields["city"]) {
            formIsValid = false;
            errors["city"] = <FormattedMessage id="emptycity.text" defaultMessage="Enter the city"/>
        }


        if (!fields["location"]) {
            formIsValid = false;
            errors["location"] = <FormattedMessage id="emptylocation.text" defaultMessage="Enter  the location"/>
        }

        if (!fields["addressOne"]) {
            formIsValid = false;
            errors["addressOne"] =<FormattedMessage id="emptyaddressonce.text" defaultMessage="Enter  the address one field"/>
        }

        if (!(this.state.isPhoneValid)) {
            formIsValid = false;
            errors["contactNumber"] = <FormattedMessage id="emptyphone.text" defaultMessage="Enter valid Phone number"/>
        }
    ...
    render() {
        ...
        if(this.state.redircetToBack){
            return <Redirect to={`/${store_locale}/address-book`} />
        }
        ...
        addAddressText =
            ...
            <div className="padding-right-ar padding-breadcrumb">
                ...
                <Link to={`/${store_locale}/address-book`} style={{ fontSize: 15 }}><span className="titleHover"><FormattedMessage id="Addresses.Text" defaultMessage="Addresses" /></span></Link>
                {language === 'en' ?
                    <span>&nbsp;\&nbsp;&nbsp;</span> :
                    <span>&nbsp;/&nbsp;&nbsp;</span>
                }
                <span style={{ fontSize: 15, fontWeight: 'bold' }}><FormattedMessage id="addnew.text" defaultMessage="Add New" /></span>
                <div className="address-add-new">
                <Link to={`/${store_locale}/address-book`}></Link>
                    <span className="addnew-header"><FormattedMessage id="addnew.text" defaultMessage="Add New" /></span></div>
            </div>
        ...
        updateAddressText = <div className="padding-right-ar padding-breadcrumb">
            ...
            <span style={{ fontSize: 15, fontWeight: 'bold' }}><FormattedMessage id="UpdateAddress.Text" defaultMessage="Update Address" /></span>
            <div className="address-add-new">
        ...
        if ('firstName' in errorsObj) {
            firstNameInputField = <div className="t-Form-inputContainer"><div className="t-Form-itemWrapper"><input type="text" id="P25_FIRST_NAME" name="P25_FIRST_NAME" className="text_field apex-item-text apex-page-item-error" onChange={this.handleChange.bind(this, "firstName")} value={this.state.AddressFields["firstName"]} size="30" maxLength="100" aria-describedby="P25_FIRST_NAME_error" aria-invalid="true" /></div><span id="P25_FIRST_NAME_error_placeholder" className="a-Form-error u-visible" data-template-id="33610259035469734_ET"><span className="t-Form-error"><div id="P25_FIRST_NAME_error">
              <FormattedMessage id="Amirah.FirstNameError" defaultMessage="Please enter first name." /></div></span></span></div>

        }
        if ('lastName' in errorsObj) {
            lastNameInputField = <div className="t-Form-inputContainer"><div className="t-Form-itemWrapper"><input type="text" id="P25_FIRST_NAME" name="P25_FIRST_NAME" className="text_field apex-item-text apex-page-item-error" onChange={this.handleChange.bind(this, "lastName")} value={this.state.AddressFields["lastName"]} size="30" maxLength="100" aria-describedby="P25_FIRST_NAME_error" aria-invalid="true" /></div><span id="P25_FIRST_NAME_error_placeholder" className="a-Form-error u-visible" data-template-id="33610259035469734_ET"><span className="t-Form-error"><div id="P25_FIRST_NAME_error">
                <FormattedMessage id="Signup.validation.lastName.empty" defaultMessage="Please enter last name." /></div></span></span></div>
                                                    ...
                                                    <div className="t-Region-body">
                                                        <div className="container">
                                                            ...
                                                            <Row className="row">
                                                                ...
                                                                <Col xs="12" lg="6" md="6" className="editAddresspopupPadding">
                                                                    <div className="t-Form-fieldContainer t-Form-fieldContainer--floatingLabel apex-item-wrapper plugin-intltelinput-www.jqueryscript.net js-show-label">
                                                                        <div className="t-Form-inputContainer PhoneNumber" style={{ overflow: 'visible' }}>
                                                                            <PhoneNumber
                                                                                changed={this.contactNumber}
                                                                                isdefaultPhone={this.state.isdefaultPhone}
                                                                                defaultPhone={{ ...defaultPhoneNumber }} />
...
export default connect(mapStateToProps, mapDispatchToProps)(AddressFormAdd);
