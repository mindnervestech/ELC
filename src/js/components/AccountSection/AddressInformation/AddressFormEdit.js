...
class AddressFormEdit extends Component {
            ...
            setTimeout(() => {
                this.setState({
                    AddressFields: {
                        ...
                        UserTelephone: parseInt(this.props.location.addressProps.telephone),
    ...
    render() {
        ...
        updateAddressText = <div className="padding-right-ar padding-breadcrumb">
            ...
            <div className="address-add-new">
                <Link to={`/${store_locale}/address-book`}> </Link>
                <span className="addnew-header"><FormattedMessage id="UpdateAddress.Text" defaultMessage="Update Address" /></span></div>
        </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(AddressFormEdit);
