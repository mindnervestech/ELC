    ...
    __renderLocations = (item, index) => {
        ...
        return (
            ...
            <li
                ...
                <div className="storeLocator-storeActions row">
                    <a className="col-6 margin-for-store" target="_blank" href={`https://www.google.com/maps?daddr=@${item.landmark}`}>
                    ...
                    <a className="col-6 margin-for-store1" target="_blank" href={`tel:${item.phone}`}>
