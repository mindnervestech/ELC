...
class Franchising extends Component {
	...
	componentDidMount() {
		this.props.onGetFranchisingData({ storeId: 1 });
	}
							...
							<div className="t-Region g-wrapper-main_content  t-Region--removeHeader t-Region--noBorder t-Region--scrollBody margin-top-lg"
								...
								<div className="t-Region-bodyWrap">
									...
									<div className="t-Region-body">
										<center> <br />
											<h1 className="t-page-titles">{this.props.franchising.title}</h1>
										...
										<div id="MiscContent">
											...
											<div
												style={{ fontSize: '14px' }}
												dangerouslySetInnerHTML={{ __html: this.props.franchising.content }}
											/>
											<div>&nbsp;</div>
										</div>
									</div>
...
const mapStateToProps = state => {
	return {
		franchising : state.static.franchising,
 	}
}

const mapDispatchToProps = dispatch => {
	return {
		onGetFranchisingData: (payload) => dispatch(actions.getFranchisingPageData(payload)),
	}
}

export default connect(mapStateToProps, mapDispatchToProps)(Franchising);
