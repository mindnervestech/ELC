...
class DuOnlineDisputeResolution extends Component {
	constructor(props) {
		super(props);
		this.state = {
			storeId: '',
	...
	getStoreInfo = () => {
		...
		if (this.state.storeId) {
			...
			API.get('eu-online-dispute-resolution-platform/storeId/' + this.state.storeId).then(res => {
			...
			<div className="t-Body-contentInner">
				<div className="container">
					<div className="row">
						...
						<h1>Eu Online Dispute Resolution Platform</h1>
							<div
...
export default DuOnlineDisputeResolution;
