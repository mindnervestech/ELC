...
import BirthDay_Img_Desktop_AR from '../../../../assets/images/BirthDayClub/BirthdayClub_Desktop_AR.jpg';
import BirthDay_Img_Desktop_EN from '../../../../assets/images/BirthDayClub/BirthdayClub_Desktop_EN.jpg';
import BirthDay_Img_Mobile_AR from '../../../../assets/images/BirthDayClub/BirthdayClub_Mobile_AR.jpg';
import BirthDay_Img_Mobile_EN from '../../../../assets/images/BirthDayClub/BirthdayClub_Mobile_EN.jpg';
            ...
            <div>
                ...
                <Row style={{ marginBottom: "40px", marginTop: "100px" }} className="check-out removeRow">
                    {/* <Col xs={12} lg={5} md={5} >
                        ...
                        {language == 'ar' ? <Col xs={12} lg={5} md={5} className="divShowOnWeb">
                            <img className="badyCloubImage" src={BirthDay_Img_Desktop_AR} alt=""></img>
                        </Col> :
                        <Col xs={12} lg={5} md={5} className="divShowOnWeb">
                            <img className="badyCloubImage" src={BirthDay_Img_Desktop_EN} alt=""></img>
                        </Col>}
                        {language == 'ar' ? <Col xs={12} lg={5} md={5} className="divShowOnMobile">
                            <img className="badyCloubImage" src={BirthDay_Img_Mobile_AR} alt=""></img>
                        </Col> :
                        <Col xs={12} lg={5} md={5} className="divShowOnMobile">
                            <img className="badyCloubImage" src={BirthDay_Img_Mobile_EN} alt=""></img>
                        </Col> }
