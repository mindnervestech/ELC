...
class AboutUs extends Component {
    ...
    render() {
        ...
        let title = "About us | ELC UAE Online store";
        ...
        if (language == 'ar') {
            title = "معلومات عنا  |  متجر مركز التعليم المبكر على الإنترنت في السعودية";
...
const mapDispatchToProps = dispatch => {
    return {
        onGetAboutUsData: (payload) => dispatch(actions.getAboutUsPageData(payload)),
    }
}
